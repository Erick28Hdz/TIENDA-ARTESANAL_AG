...
import LoginFormSection from "@/modules/user/login/sections/LoginFormSection";
import RegisterFormSection from "@/modules/user/login/sections/RegisterFormSection";
