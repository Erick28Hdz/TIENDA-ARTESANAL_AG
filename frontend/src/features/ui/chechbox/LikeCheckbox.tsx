...
const StyledWrapper = styled.div`
  ...
  .container input:checked ~ .like {
    ...
    animation: up_3951 0.6s forwards;
  }

  .container input:checked ~ .checkmark .icon {
    fill: var(--color-cuaternario2);
    transform: none;
    animation: jump_3951 0.5s forwards;
  }
