...
export type BuyButtonVariant = "buy" | "cart";
...
const BuyButton: React.FC<BuyButtonProps> = ({ variant = "buy", className }) => {
  const text = variant === "buy" ? "Comprar ahora" : "Añadir al carrito";
